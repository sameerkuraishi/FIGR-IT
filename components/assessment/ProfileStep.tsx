  ...
  return (
    <div className="flex flex-col gap-8 max-w-5xl mx-auto">
        ...
        <section className="lg:col-span-2 premium-card p-6 md:p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <label className="flex flex-col gap-2 text-sm font-semibold text-[var(--winter-dark)]">
              ...
              <small className="text-xs text-[var(--muted-foreground)] font-normal">Selects a relevant assessment route.</small>
            </label>
            <label className="flex flex-col gap-2 text-sm font-semibold text-[var(--winter-dark)]">
              Learning Budget
              <select 
      ...
      <section className="premium-card p-6 md:p-8">
        ...
        <p className="text-[var(--muted-foreground)] mb-6">Select the areas that genuinely spark your curiosity.</p>
        <div className="flex flex-wrap gap-3">
          {interestChoices.map((item) => {
            ...
            return (
              <button 
                key={item} 
                onClick={() => updateProfile("interests", selected ? profile.interests.filter((i) => i !== item) : [...profile.interests, item])}
      ...
      <section className="premium-card p-6 md:p-8">
        ...
        <div className="flex justify-end pt-6 border-t border-[var(--border)]">
          <Button onClick={() => setStep("assessment")} className="btn-primary text-base px-8 h-12">
            Start My Assessment <ArrowRight className="w-5 h-5 ml-1" />
          </Button>
        </div>
      </section>
    </div>
